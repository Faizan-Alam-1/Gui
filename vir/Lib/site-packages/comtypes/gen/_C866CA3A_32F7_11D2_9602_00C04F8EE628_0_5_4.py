...
__all__ = [
    'SpeechTokenContext', 'ISpRecoGrammar', 'DISPID_SPRuleName',
    'DISPID_SAStatus', 'SPPROPERTYINFO', 'SPEI_RESERVED2',
    'SAFTADPCM_8kHzMono', 'SAFT32kHz8BitStereo',
    'DISPID_SVAlertBoundary', 'SAFTCCITT_uLaw_22kHzStereo',
    'SREStreamStart', 'SVEEndInputStream', 'ISpeechMemoryStream',
    'DISPID_SpeechRecognizerStatus', 'SVEAllEvents', 'ISpLexicon',
    'DISPID_SPPId', 'ISpeechWaveFormatEx', 'ISpResourceManager',
    'SVSFParseAutodetect', 'SVP_13', 'DISPID_SDKDeleteValue',
    'DISPID_SABIEventBias', 'SRTEmulated', 'DISPID_SRRecognizer',
    'ISpEventSource', 'SPSMF_SAPI_PROPERTIES', 'SPBO_NONE',
    'DISPID_SGRInitialState', 'SSFMOpenForRead', 'ISpPhrase',
    'SAFT24kHz16BitStereo', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SPRuleId',
    'DISPID_SBSRead', 'SPXRO_SML', 'DISPID_SRCEInterference',
    'ISpeechRecoResult', 'DISPID_SVESentenceBoundary',
    'DISPID_SABIBufferSize', 'DISPID_SRCEAudioLevel',
    'DISPID_SDKEnumKeys', 'eLEXTYPE_PRIVATE4',
    'DISPID_SpeechAudioStatus', 'SPPHRASEREPLACEMENT',
    'SpeechCategoryRecoProfiles', 'SRADefaultToActive',
    'SWPUnknownWordUnpronounceable', 'SRERecognition',
    'DISPID_SWFEAvgBytesPerSec', 'SpeechStreamFileMode',
    'DISPID_SPCIdToPhone', 'SpAudioFormat',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SVSPhonemeId', 'SVF_Stressed', 'DISPID_SRCCreateGrammar',
    'DISPID_SOTCreateInstance', 'SAFT22kHz16BitMono',
    'SAFTADPCM_8kHzStereo', 'eLEXTYPE_RESERVED6',
    'SpSharedRecoContext', 'SGDisplay', 'DISPID_SGRSTs_NewEnum',
    'eLEXTYPE_PRIVATE10', 'STSF_AppData', 'DISPID_SLPSymbolic',
    'SPINTERFERENCE_NOISE', 'SREPhraseStart', 'SVP_18',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SPPs_NewEnum',
    'SP_VISEME_20', 'SSSPTRelativeToCurrentPosition', 'SREBookmark',
    'DISPID_SRCSetAdaptationData', 'SPPHRASE',
    'DISPID_SVSLastBookmark', 'DISPID_SRSAudioStatus', 'SGRSTTRule',
    'DISPID_SRCRecognizer', 'DISPID_SRRSaveToMemory',
    'DISPID_SpeechVoice', 'SpeechRecognitionType',
    'SpPhraseInfoBuilder', 'SpUnCompressedLexicon',
    'DISPID_SPPConfidence', 'ISpRecognizer',
    'SAFTExtendedAudioFormat', 'SVSFNLPSpeakPunc',
    'DISPID_SRGIsPronounceable', 'SpInprocRecognizer',
    'SREAdaptation', 'eLEXTYPE_PRIVATE3', 'ISpXMLRecoResult',
    'SPDKL_CurrentConfig', 'DISPID_SPIProperties', 'SINoise',
    'SAFT32kHz8BitMono', 'SpeechTokenKeyFiles',
    'DISPID_SOTMatchesAttributes', 'SpeechCategoryAudioOut',
    ...
    'DISPID_SVRate', 'DISPID_SPARecoResult',
    'DISPID_SVAudioOutputStream', 'SREStreamEnd',
    'DISPID_SPIReplacements', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SPCPhoneToId', 'SGRSTTWord', 'SAFTCCITT_ALaw_11kHzMono',
    'SRAInterpreter', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SpNullPhoneConverter', 'ISequentialStream',
    'SAFTADPCM_44kHzMono', 'SP_VISEME_6', 'SPRECORESULTTIMES',
    'SRTExtendableParse', 'SpLexicon', 'DISPID_SRCVoicePurgeEvent',
    'SPBINARYGRAMMAR', 'DISPID_SRRGetXMLResult', 'SPFM_CREATE',
    'SPPS_Interjection', 'DISPID_SOTId',
    'DISPID_SRGCmdLoadFromResource', 'SPEI_PROPERTY_STRING_CHANGE',
    'SpeechAudioProperties', 'DISPID_SDKSetLongValue',
    'DISPID_SpeechObjectTokenCategory', 'SREPropertyNumChange',
    'ISpObjectToken', 'SASRun', 'SDTDisplayText', 'DISPID_SPPValue',
    'SPRST_NUM_STATES', 'DISPID_SOTCategory', 'SAFTText', 'SWTAdded',
    'SREHypothesis', 'ISpStreamFormat', 'SAFT48kHz16BitMono',
    'DISPID_SVEventInterests', 'SVSFParseSsml', 'SECHighConfidence',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SPRNumberOfElements',
    'DISPID_SRGDictationUnload', 'DISPID_SVPause',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SGRAttributes',
    'SAFT8kHz16BitMono', 'eLEXTYPE_PRIVATE1', 'SVESentenceBoundary',
    'Speech_Default_Weight', 'ISpeechObjectTokens',
    'DISPID_SRRTStreamTime', 'SpeechRuleAttributes',
    'SpeechSpecialTransitionType', 'DISPID_SpeechPhraseElements',
    'SAFT12kHz16BitStereo', 'SPEI_SOUND_START', 'SP_VISEME_1',
    'DISPID_SRCreateRecoContext', 'SGRSTTTextBuffer',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SDKSetStringValue', 'SpeechTokenValueCLSID',
    'SPRST_ACTIVE', 'SREStateChange', 'SRARoot',
    'SPSEMANTICERRORINFO', 'DISPID_SRSCurrentStreamNumber',
    'SPCT_SLEEP', 'DISPID_SADefaultFormat',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SDKGetBinaryValue',
    'SDA_One_Trailing_Space', 'SPSVerb', 'SpeechTokenIdUserLexicon',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SpeechGrammarRules', 'SGSEnabled',
    'DISPID_SpeechLexiconWords', 'eLEXTYPE_USER',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SGRSTPropertyValue',
    'DISPID_SGRsDynamic', 'DISPID_SAFSetWaveFormatEx',
    'SVEStartInputStream', 'ISpPhraseAlt', 'SP_VISEME_10', 'SVPOver',
    'SPCATEGORYTYPE', 'SAFT48kHz8BitStereo', 'SPAS_CLOSED',
    'DISPID_SFSOpen', 'DISPID_SRRAudio', 'SPAS_STOP',
    'eLEXTYPE_VENDORLEXICON', 'SPEI_RESERVED5', 'DISPID_SGRs_NewEnum',
    'SECFNoSpecialChars', 'ISpeechPhraseAlternate',
    'DISPID_SVGetProfiles', 'DISPID_SGRSTRule', 'SPEI_WORD_BOUNDARY',
    'SPAO_NONE', 'DISPID_SRCRequestedUIType', 'ISpeechVoiceStatus',
    'DISPID_SRRTimes', 'SAFT44kHz16BitMono', 'SpFileStream',
    'DISPID_SDKGetlongValue', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SOTGetStorageFileName', 'DISPID_SpeechAudioFormat',
    'SpeechRunState', 'DISPID_SPIAudioSizeBytes', 'SPEI_RESERVED3',
    'DISPID_SWFESamplesPerSec', 'SGSDisabled', 'SRAONone',
    'SAFT24kHz16BitMono', 'SPAR_Unknown', 'ISpRecoResult',
    'DISPID_SRCBookmark', 'SRESoundStart', 'ISpeechAudioStatus',
    'SPEI_SR_AUDIO_LEVEL', 'SpeechRuleState',
    'SpeechEngineConfidence', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SASNonBlockingIO', 'DISPID_SpeechPhraseRules',
    'DISPID_SRRAudioFormat', 'SPSHT_OTHER', 'SRSInactive',
    'eLEXTYPE_RESERVED4', 'SpeechTokenShellFolder', 'SREAllEvents',
    'ISpShortcut', 'SPEI_RESERVED6', 'SECFIgnoreWidth',
    'SPWF_SRENGINE', 'SP_VISEME_9', 'ISpStream', 'SpeechUserTraining',
    'DISPID_SOTsCount', 'DISPID_SOTRemoveStorageFileName',
    'SPAUDIOSTATE', 'SAFT8kHz8BitStereo', 'SPWORDPRONOUNCEABLE',
    '_ISpeechVoiceEvents', 'SFTSREngine', 'SRAImport',
    'DISPID_SRStatus', 'DISPID_SpeechObjectTokens',
    'DISPID_SGRSTsItem', 'SpStreamFormatConverter',
    'DISPID_SOTCGetDataKey', 'IStream', 'SECFIgnoreKanaType',
    'DISPID_SDKDeleteKey', 'SLODynamic', 'SPFILEMODE',
    'SpeechRecognizerState', 'SpPhoneticAlphabetConverter',
    'eLEXTYPE_PRIVATE17', 'SPDKL_DefaultLocation',
    'DISPID_SPISaveToMemory', 'SAFTADPCM_22kHzStereo', 'SP_VISEME_12',
    'DISPID_SLAddPronunciationByPhoneIds', 'SpeechEngineProperties',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SPIAudioSizeTime',
    'Speech_Max_Pron_Length', 'DISPID_SGRSTText',
    'DISPID_SGRSAddRuleTransition', 'SpWaveFormatEx',
    'ISpRecoGrammar2', 'eLEXTYPE_RESERVED10', 'DISPID_SPRText',
    'SpTextSelectionInformation', 'ISpRecoContext2',
    'ISpGrammarBuilder', 'ISpeechPhraseAlternates',
    'DISPID_SPIAudioStreamPosition', 'SP_VISEME_2',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SRCRetainedAudioFormat',
    'SAFT16kHz16BitStereo', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SPRuleChildren', 'DISPID_SRGReset',
    'DISPID_SLGetGenerationChange',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SLGetPronunciations', 'DISPID_SVWaitUntilDone',
    'SAFTGSM610_22kHzMono', 'SAFT22kHz8BitMono', 'SPEI_HYPOTHESIS',
    'DISPID_SGRSTransitions', 'SVSFVoiceMask', 'SSSPTRelativeToEnd',
    'SpeechPropertyLowConfidenceThreshold', 'SPSMF_UPS',
    'DISPID_SRAudioInputStream', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SPEActualConfidence', 'SVEBookmark',
    'DISPID_SRCERecognition', 'SP_VISEME_14', 'DISPID_SOTsItem',
    'SREInterference', 'ISpeechXMLRecoResult',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SPPFirstElement',
    'SVSFIsXML', 'DISPID_SLPsItem', 'DISPID_SVGetAudioOutputs',
    'DISPIDSPTSI', 'SAFT44kHz16BitStereo', 'DISPID_SRCEEndStream',
    'DISPID_SpeechRecoResult', 'DISPID_SRGDictationSetState',
    'DISPID_SGRName', 'SpMMAudioIn', 'SAFT16kHz16BitMono',
    'SAFTADPCM_11kHzStereo', 'SPWAVEFORMATTYPE', 'SSFMOpenReadWrite',
    'SGRSTTDictation', 'SPSModifier', 'DISPID_SMSGetData',
    'DISPID_SpeechXMLRecoResult', 'SRATopLevel', 'SDKLLocalMachine',
    'SGDSActiveWithAutoPause', 'ISpObjectWithToken', 'DISPID_SVEWord',
    'SPXMLRESULTOPTIONS', 'DISPID_SRCEFalseRecognition',
    'SPSInterjection', 'SDTAll', 'eLEXTYPE_PRIVATE15',
    'ISpStreamFormatConverter', 'SP_VISEME_4', 'SPEVENTENUM',
    'SP_VISEME_15', 'SpeechInterference',
    'DISPID_SRSetPropertyString', 'SECFDefault', 'eLEXTYPE_RESERVED8',
    'SGDSActive', 'DISPID_SVSInputWordLength', 'SPSFunction',
    'SPRS_ACTIVE', 'SpeechRegistryUserRoot', 'DISPID_SOTSetId',
    'DISPID_SVEViseme', 'SPPS_LMA', 'DISPID_SMSALineId',
    'SPCS_DISABLED', 'SP_VISEME_0', 'DISPID_SLPsCount',
    'SPXRO_Alternates_SML', 'SpPhoneConverter', 'DISPID_SRGState',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SpeechPhraseProperty', 'SDTPronunciation', 'SVP_15',
    'SpeechWordType', 'DISPID_SPPBRestorePhraseFromMemory',
    'SAFTCCITT_uLaw_11kHzStereo', 'eLEXTYPE_PRIVATE9',
    'DISPID_SPPsItem', 'DISPID_SMSAMMHandle',
    'ISpeechPhraseProperties', 'SAFTCCITT_ALaw_22kHzStereo',
    'SpeechVoiceSpeakFlags', 'SGSExclusive',
    'DISPID_SPPNumberOfElements', 'ISpeechRecoContext',
    'DISPID_SPANumberOfElementsInResult', 'SAFT16kHz8BitMono',
    'DISPID_SPAsItem', 'eLEXTYPE_PRIVATE19', 'SPEI_RESERVED1',
    'DISPID_SOTGetDescription', 'DISPID_SRGSetWordSequenceData',
    'SPEI_SOUND_END', 'SP_VISEME_21', 'DISPID_SVPriority', 'SPRULE',
    'SPGS_DISABLED', 'SGDSActiveUserDelimited', 'SPVPRI_ALERT',
    'SVSFParseMask', 'DISPID_SREmulateRecognition', 'SPSHORTCUTPAIR',
    'ISpeechAudio', 'SBONone', 'DISPID_SOTCId', 'SDTLexicalForm',
    'DISPID_SVSLastResult', 'SPWORDLIST', 'eLEXTYPE_PRIVATE20',
    'ISpeechRecoGrammar', 'ISpRecoContext', 'SVP_19', 'SPEI_MIN_SR',
    'ISpeechVoice', 'SpeechAudioFormatGUIDText', 'SP_VISEME_11',
    'SRCS_Enabled', 'SPAR_Medium',
    'DISPID_SpeechGrammarRuleStateTransition', 'eLEXTYPE_APP',
    'SPWORDPRONUNCIATIONLIST', 'SVSFIsFilename', 'STCInprocHandler',
    'SSSPTRelativeToStart', 'DISPID_SPRDisplayAttributes',
    'SECFEmulateResult', 'DISPID_SpeechMMSysAudio',
    'ISpeechPhraseRule', 'SpeechDataKeyLocation',
    'SpeechTokenKeyAttributes', 'SPPHRASERULE', 'SPRST_INACTIVE',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SRGCmdLoadFromFile',
    'ISpeechPhraseProperty', 'DISPID_SpeechPhraseRule',
    'DISPID_SpeechRecoContext', 'DISPID_SDKGetStringValue',
    'DISPID_SWFEBlockAlign', 'DISPID_SPIRetainedSizeBytes',
    'SPLEXICONTYPE', 'DISPID_SVEAudioLevel', 'eLEXTYPE_PRIVATE6',
    'SWPUnknownWordPronounceable', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SVSkip', 'ISpeechRecoResultTimes', 'SPSHORTCUTPAIRLIST',
    ...
    'SAFTADPCM_22kHzMono', 'DISPID_SGRSTNextState', 'SP_VISEME_16',
    'SPRS_INACTIVE', 'SPWT_DISPLAY', 'DISPID_SVEPhoneme',
    'SPCT_COMMAND', 'SPTEXTSELECTIONINFO', 'SAFT24kHz8BitStereo',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SRRDiscardResultInfo', 'STSF_CommonAppData',
    'DISPID_SpeechCustomStream', 'DISPID_SPPName', 'SP_VISEME_3',
    'DISPID_SVEBookmark', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SLGetWords', 'SECLowConfidence', 'SAFT12kHz8BitMono',
    'SpeechGrammarWordType', 'SPLO_DYNAMIC', 'DISPID_SRAudioInput',
    'SpeechRetainedAudioOptions', 'ISpVoice', 'SGRSTTEpsilon',
    'SPEI_VOICE_CHANGE', 'DISPID_SPPsCount', 'SAFT11kHz8BitMono',
    '_RemotableHandle', 'DISPID_SVVolume', 'ISpRecoCategory',
    'SAFTGSM610_44kHzMono', 'DISPID_SVResume', 'SAFT11kHz16BitStereo',
    'SPVISEMES', 'SVP_2', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SRRPhraseInfo', 'SpMMAudioEnum', 'SPINTERFERENCE_TOOLOUD',
    'SPEI_FALSE_RECOGNITION', 'SVP_7', 'SVP_8',
    'DISPID_SVSpeakStream', 'SPRECOCONTEXTSTATUS', 'DISPID_SRCVoice',
    'SPEI_SR_BOOKMARK', 'SPWT_PRONUNCIATION',
    'ISpeechLexiconPronunciations', 'DISPID_SGRSTType',
    'DISPID_SWFEExtraData', 'SPEVENTSOURCEINFO', 'SPDKL_CurrentUser',
    'DISPID_SRGetPropertyString', 'DISPID_SPIRule',
    'DISPID_SPPParent', 'ISpeechAudioFormat', 'SGDSInactive',
    'ISpPhoneticAlphabetSelection', 'DISPID_SRIsShared', 'SVP_12',
    'DISPID_SLPPhoneIds', 'SRTReSent', 'SPPS_NotOverriden',
    'DISPID_SVEVoiceChange', 'DISPID_SVSyncronousSpeakTimeout',
    'ISpNotifySource', 'SINoSignal', 'IEnumSpObjectTokens',
    'DISPID_SABufferInfo', 'SGRSTTWildcard', 'DISPID_SVAudioOutput',
    'DISPID_SPIGetText', 'SPSERIALIZEDRESULT',
    'DISPID_SPRules_NewEnum', 'SVP_3', 'DISPID_SpeechDataKey',
    'DISPID_SPELexicalForm', 'eLEXTYPE_PRIVATE12', 'SP_VISEME_7',
    'eLEXTYPE_PRIVATE5', 'ISpeechLexiconWord', 'DISPID_SPAsCount',
    'DISPID_SVVoice', 'DISPID_SRIsUISupported',
    'DISPID_SGRSTPropertyId', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'ISpeechTextSelectionInformation', 'SPWORDTYPE', 'SLOStatic',
    'ISpeechRecoResultDispatch', 'SPSEMANTICFORMAT',
    'DISPID_SPRulesCount', 'SVEAudioLevel', 'SITooQuiet',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SRCEventInterests',
    'eLEXTYPE_MORPHOLOGY', 'SPWORD', 'LONG_PTR', 'ISpRecognizer2',
    'DISPID_SRCPause', 'DISPID_SRCESoundEnd',
    'DISPID_SVSpeakCompleteEvent', 'SpObjectToken', 'DISPID_SLWType',
    '__MIDL_IWinTypes_0009', 'SINone', 'ISpeechDataKey',
    'SPGS_ENABLED', 'DISPID_SRGId', 'DISPID_SPRuleFirstElement',
    'DISPID_SPEAudioStreamOffset', 'SPWT_LEXICAL', 'SPSSuppressWord',
    'SREFalseRecognition', 'eLEXTYPE_PRIVATE13',
    'DISPID_SPRs_NewEnum', 'DISPID_SRGetPropertyNumber',
    '_SPAUDIOSTATE', 'DISPID_SPRuleParent', 'SPINTERFERENCE',
    'DISPID_SVSVisemeId', 'SREAudioLevel', 'SECNormalConfidence',
    'SpeechPartOfSpeech', 'ISpeechGrammarRules',
    'ISpeechRecognizerStatus', 'DISPID_SpeechPhraseReplacement',
    'ISpEventSink', 'SSFMCreateForWrite', 'DISPID_SGRsAdd',
    'SDKLDefaultLocation', 'IEnumString', 'ISpeechPhraseElement',
    'SASStop', 'SPEI_START_INPUT_STREAM', 'SPPS_RESERVED2',
    'SRTAutopause', 'SPFM_NUM_MODES', 'SPSERIALIZEDPHRASE',
    'SPWF_INPUT', 'ISpProperties', 'SRADynamic', 'SVSFPersistXML',
    'SAFT8kHz16BitStereo', 'SPINTERFERENCE_NOSIGNAL',
    'SpeechAudioFormatGUIDWave', 'DISPID_SOTCSetId', 'SPAUDIOSTATUS',
    'SSFMCreate', 'SPEI_TTS_AUDIO_LEVEL', 'SPSHT_EMAIL', 'SpVoice',
    'SAFT32kHz16BitMono', 'SVF_None', 'SBOPause', 'SpMemoryStream',
    'SPLOADOPTIONS', 'SAFTTrueSpeech_8kHz1BitMono', 'ISpNotifySink',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SABufferNotifySize', 'DISPID_SCSBaseStream',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SVGetVoices', 'DISPID_SpeechPhraseElement',
    'DISPID_SLWWord', 'SpMMAudioOut', 'SVP_6', 'SVPNormal',
    'SpeechDisplayAttributes', 'DISPID_SVSInputSentencePosition',
    'tagSPPROPERTYINFO', 'DISPID_SLWsItem', 'DISPID_SVSpeak',
    'SPCT_SUB_DICTATION', 'DISPID_SPEsCount', 'SPVPRIORITY',
    'STCInprocServer', 'SpStream', 'SPEI_PHRASE_START',
    'SDKLCurrentUser', 'SpCustomStream', 'SPCT_SUB_COMMAND',
    'eLEXTYPE_PRIVATE7', 'SpeechVisemeFeature', 'DISPID_SWFEChannels',
    'DISPID_SPRFirstElement', 'DISPID_SRRSpeakAudio',
    'SpeechStreamSeekPositionType', 'DISPID_SPPChildren', 'SPSLMA',
    'DISPID_SOTRemove', 'eLEXTYPE_RESERVED9', 'eLEXTYPE_RESERVED7',
    'SVPAlert', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SpeechPhraseAlternates', 'SPPS_Noncontent', 'SPEI_MAX_SR',
    'DISPID_SpeechRecoResult2', 'SPEI_VISEME',
    'ISpeechPhraseReplacements', 'DISPID_SpeechPhraseInfo',
    'DISPID_SOTCDefault', 'DISPID_SpeechVoiceStatus', 'SPAS_PAUSE',
    'STCLocalServer', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SVEStreamEnd', 'DISPID_SRCRetainedAudio',
    'DISPID_SPRsItem', 'DISPID_SLPPartOfSpeech',
    'Speech_StreamPos_RealTime', 'DISPID_SVIsUISupported',
    'SAFTNoAssignedFormat', 'ISpeechObjectToken',
    'SPSTREAMFORMATTYPE', 'SPEVENT', 'SpNotifyTranslator',
    'SPSHORTCUTTYPE', 'DISPID_SGRClear', 'SPPHRASEPROPERTY',
    'DISPID_SLWs_NewEnum', 'SDTReplacement',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SRRSetTextFeedback', 'SpeechCategoryPhoneConverters',
    'DISPID_SABIMinNotification', 'SP_VISEME_8',
    'IInternetSecurityManager', 'SPAUDIOOPTIONS', 'SPSNoun',
    'SPBOOKMARKOPTIONS', 'DISPID_SRGRecoContext',
    'SREPropertyStringChange', 'DISPID_SLWLangId',
    'DISPID_SPEDisplayAttributes', 'SpeechGrammarTagDictation',
    'SLTUser', 'ISpDataKey', 'DISPID_SRState', 'SPSHT_Unknown',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SLAddPronunciation', 'SVSFNLPMask', 'SVP_21',
    'SRERequestUI', 'DISPID_SAFType', 'DISPID_SPIGrammarId',
    'DISPID_SVDisplayUI', 'SRSActive', 'SPSHT_NotOverriden',
    'DISPID_SpeechAudioBufferInfo', 'SITooLoud', 'SP_VISEME_17',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SWFEFormatTag',
    'SPPS_Noun', 'SASPause', 'SpeechAudioFormatType',
    'eLEXTYPE_PRIVATE2', 'SpeechPropertyResponseSpeed',
    'DISPID_SPEEngineConfidence', 'SVP_10', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SDKEnumValues', 'DISPID_SRGRules', 'SVP_14',
    'SpResourceManager', 'DISPID_SBSFormat', 'SpeechAddRemoveWord',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPCS_ENABLED',
    'SPEI_SR_RETAINEDAUDIO', 'SPEI_PHONEME',
    'DISPID_SPPEngineConfidence', 'SPPS_Function', 'SP_VISEME_18',
    'ISpeechBaseStream', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SGRsCommit', 'SDTRule', 'DISPID_SLWPronunciations',
    'DISPID_SpeechObjectToken', 'SPPS_Verb', 'STCAll', 'SVP_16',
    'SVSFlagsAsync', 'SAFTCCITT_ALaw_22kHzMono', 'SpeechLexiconType',
    'DISPID_SOTDisplayUI', 'DISPID_SOTs_NewEnum', 'SPGRAMMARSTATE',
    'SRSEDone', 'ISpeechPhraseReplacement', 'SPVPRI_NORMAL',
    'SPPS_Unknown', 'DISPID_SRProfile', 'SSTTDictation',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SGRAddResource',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SVSCurrentStreamNumber',
    'SPGRAMMARWORDTYPE', 'DISPID_SPACommit', 'DISPID_SGRsCount',
    'SRERecoOtherContext', 'SpeechWordPronounceable',
    'DISPID_SBSSeek', 'SRAExport', 'SpCompressedLexicon',
    'SPFM_OPEN_READONLY', 'SDTAudio', 'SpeechVoiceCategoryTTSRate',
    'SpeechGrammarTagWildcard', 'ISpAudio', 'DISPID_SASState',
    'SpeechVoiceEvents', 'SPBO_TIME_UNITS',
    'DISPID_SGRSAddWordTransition', 'DISPID_SBSWrite',
    'SpeechMicTraining', 'eLEXTYPE_LETTERTOSOUND', 'SVEViseme',
    'ISpeechCustomStream', 'SPEI_MIN_TTS', 'SAFTGSM610_11kHzMono',
    'SPDATAKEYLOCATION', 'UINT_PTR', 'DISPID_SOTCEnumerateTokens',
    'SPRST_ACTIVE_ALWAYS', 'SPRECOSTATE', 'DISPID_SRCESoundStart',
    'ISpeechLexiconPronunciation', 'DISPID_SPRuleNumberOfElements',
    'ISpeechResourceLoader', 'DISPID_SGRSTWeight',
    'ISpeechGrammarRuleState', 'DISPID_SVSLastBookmarkId',
    'DISPID_SRGSetTextSelection', 'SPAUDIOBUFFERINFO',
    'STCRemoteServer', 'DISPID_SPEPronunciation', 'SVEWordBoundary',
    'SPPARTOFSPEECH', 'SPWORDPRONUNCIATION', 'SpeechCategoryAudioIn',
    'DISPID_SRCResume', 'SPSNotOverriden', 'DISPID_SPRulesItem',
    'DISPID_SRCEPropertyStringChange', 'SRTStandard',
    'SPEI_SR_PRIVATE', 'DISPID_SVSRunningState', 'SVP_5', 'SASClosed',
    'DISPID_SWFEBitsPerSample', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SASFreeBufferSpace', 'SPPS_RESERVED3',
    'SPINTERFERENCE_TOOFAST', 'SpeechCategoryAppLexicons',
    'SPPS_SuppressWord', 'SAFT8kHz8BitMono',
    'DISPID_SAFGetWaveFormatEx', 'SpeechCategoryRecognizers',
    'DISPID_SPAStartElementInResult', 'SPGS_EXCLUSIVE', 'SWTDeleted',
    'SPPS_Modifier', 'DISPID_SLRemovePronunciation',
    'SAFT11kHz16BitMono', 'SPADAPTATIONRELEVANCE', 'SPCONTEXTSTATE',
    'DISPID_SPRuleConfidence', 'DISPID_SpeechVoiceEvent', 'SITooSlow',
    'SDA_Consume_Leading_Spaces', 'SpeechAudioState',
    'DISPID_SRCState', 'SP_VISEME_19', 'SAFTNonStandardFormat',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SPILanguageId',
    'SSTTTextBuffer', 'DISPID_SpeechPhraseBuilder', 'SSTTWildcard',
    'DISPID_SAEventHandle', 'SpeechLoadOption', 'ISpeechLexiconWords',
    'SVEVoiceChange', 'SVEPrivate', 'DISPID_SASetState',
    ...
    'DISPID_SVSInputSentenceLength', 'SpeechPropertyResourceUsage',
    ...
    'ISpeechRecognizer', 'DISPID_SPCLangId', 'DISPID_SPRsCount',
    'SPRULESTATE', 'SVP_1', 'DISPID_SRGDictationLoad', 'SVP_20',
    'SpeechPropertyAdaptationOn', 'ISpeechRecoResult2',
    'eLEXTYPE_PRIVATE18', 'SAFT24kHz8BitMono',
    'DISPID_SRCEHypothesis', 'ISpSerializeState',
    'SPEI_RECO_OTHER_CONTEXT', 'SAFT44kHz8BitMono',
    'SPEI_RECOGNITION', 'SpeechTokenKeyUI', 'SpeechRecoEvents',
    'SpeechDictationTopicSpelling', 'SECFIgnoreCase', 'SP_VISEME_13',
    'SPINTERFERENCE_TOOQUIET', 'DISPIDSPTSI_ActiveLength',
    'SAFTGSM610_8kHzMono', 'DISPID_SpeechBaseStream',
    'SpeechVoicePriority', 'DISPID_SRSSupportedLanguages',
    'SPRECOGNIZERSTATUS', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SRDisplayUI', 'SVP_0', 'DISPID_SpeechGrammarRuleState',
    'SVSFUnusedFlags', 'SPDKL_LocalMachine', 'DISPID_SGRId',
    'DISPID_SpeechPhraseReplacements', 'SpeechBookmarkOptions',
    'DISPID_SRRRecoContext', 'SVSFPurgeBeforeSpeak', 'ISpeechLexicon',
    ...
    'SPEI_INTERFERENCE', 'SpeechRegistryLocalMachineRoot',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SpeechMemoryStream',
    'DISPID_SAFGuid', 'DISPIDSPTSI_SelectionOffset', 'SVSFIsNotXML',
    'SP_VISEME_5', 'DISPID_SPIEngineId', 'SRSEIsSpeaking',
    'SRAORetainAudio', 'SDA_Two_Trailing_Spaces', 'WAVEFORMATEX',
    'SPCT_DICTATION', 'ISpeechGrammarRule', 'SPSUnknown',
    'SWPKnownWordPronounceable', 'ISpeechPhraseInfo',
    'DISPID_SOTIsUISupported', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SAFTCCITT_uLaw_22kHzMono', 'SRESoundEnd', 'SLTApp',
    'DISPID_SRCEAdaptation', 'SAFT48kHz16BitStereo',
    'SPEI_ADAPTATION', 'ISpeechObjectTokenCategory', 'SPBO_AHEAD',
    'DISPID_SVEStreamStart', 'tagSTATSTG', 'SDTProperty',
    'DISPID_SAVolume', 'DISPID_SRRTLength', 'SAFT32kHz16BitStereo',
    'SVF_Emphasis', 'SPEI_MAX_TTS', 'DISPID_SRCEBookmark', 'SFTInput',
    'SRCS_Disabled', 'SAFTDefault', 'DISPID_SDKSetBinaryValue',
    'DISPID_SFSClose', 'DISPID_SPAPhraseInfo', 'SPEI_TTS_PRIVATE',
    'Speech_Max_Word_Length', 'SGLexical',
    'SpeechVoiceSkipTypeSentence', 'SAFTADPCM_11kHzMono',
    'DISPID_SPEAudioSizeTime', 'DISPID_SPEsItem', 'SVP_17',
    ...
    'SpeechRecoProfileProperties', 'SpeechAllElements',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SGRsFindRule',
    'SPINTERFERENCE_NONE', 'SPBO_PAUSE', 'SPVOICESTATUS', 'SVP_4',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SGRAddState',
    'tagSPTEXTSELECTIONINFO', 'ISpeechPhraseRules',
    'ISpeechFileStream', 'DISPID_SRRTTickCount', 'DISPID_SMSSetData',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SVEEnginePrivate',
    'DISPID_SLPs_NewEnum', 'SPEI_REQUEST_UI',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SRCCmdMaxAlternates', 'SPAR_High', 'eLEXTYPE_PRIVATE11',
    ...
    'SVP_9', 'eWORDTYPE_ADDED', 'SDKLCurrentConfig',
    'SpeechVisemeType', 'SPAR_Low', 'SAFT44kHz8BitStereo',
    'DISPID_SpeechGrammarRule', 'SPEI_START_SR_STREAM',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SITooFast',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SpeechLexiconWord',
    'DISPID_SpeechLexicon', 'SPAO_RETAIN_AUDIO', 'eWORDTYPE_DELETED',
    'SVEPhoneme', 'SAFT12kHz8BitStereo', 'DISPID_SDKCreateKey',
    'SPPS_RESERVED1', 'DISPID_SRCEEnginePrivate',
    'ISpeechPhoneConverter', 'SPEI_END_SR_STREAM',
    'SpeechAudioVolume', 'SPEI_UNDEFINED', 'SVSFDefault',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SDKOpenKey',
    'SAFT12kHz16BitMono', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SMSADeviceId', 'DISPID_SPAs_NewEnum',
    'SpInProcRecoContext', 'SPVPRI_OVER', 'DISPID_SpeechLexiconProns',
    'ISpeechPhraseInfoBuilder', 'SVP_11', 'DISPID_SpeechFileStream',
    'DISPID_SPEs_NewEnum', 'DISPID_SpeechAudio', 'DISPID_SLPLangId',
    'DISPID_SRSCurrentStreamPosition', 'SRSActiveAlways',
    'SpShortcut', 'DISPID_SRGCommit', 'DISPID_SPIEnginePrivateData',
    'STSF_FlagCreate', 'ISpeechAudioBufferInfo', 'SpeechDiscardType',
    'DISPID_SLWsCount', 'SREPrivate', 'DISPID_SpeechRecognizer',
    'SpObjectTokenCategory', 'SAFT22kHz16BitStereo',
    'DISPID_SOTDataKey', 'ISpeechPhraseElements', 'DISPIDSPRG',
    'ISpMMSysAudio', '_ISpeechRecoContextEvents',
    'DISPID_SGRSTsCount', 'DISPID_SVStatus', 'ISpNotifyTranslator',
    'DISPID_SRSetPropertyNumber', 'ISpRecognizer3',
    'SRSInactiveWithPurge', 'SAFT11kHz8BitStereo', 'SGPronounciation',
    'SAFT22kHz8BitStereo', 'SPPHRASEELEMENT',
    'ISpObjectTokenCategory', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'ISpPhoneConverter', 'eLEXTYPE_PRIVATE16',
    'DISPID_SLGenerationId', 'SpSharedRecognizer',
    'STSF_LocalAppData', 'SAFTCCITT_ALaw_8kHzMono',
